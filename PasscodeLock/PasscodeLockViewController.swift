...
public class PasscodeLockViewController: UIViewController, PasscodeLockTypeDelegate {
    ...
    internal func updatePasscodeView() {
        ...
        touchIDButton?.setTitle(localizedStringFor("Use TouchID", comment: "Use TouchID"), for: UIControlState())
        deleteSignButton?.setTitle(localizedStringFor("Delete", comment: "Delete"), for: UIControlState())
    }
